...
function fizzBuzz(numero) {
  ...
  const esDivisiblePor = (unNumero, divisor) => unNumero % divisor === 0;
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if(argumentos.includes(0)) {
    return "Error";
  } else if (argumentos.some(esNegativo)) {
    return "Hay negativos";
  } else if (num3 > num1 && num3 > num2) {
    return num3 + 1;
  } else if (num1 > num2 && num1 > num3 && !esNegativo(num1)) {
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  let numeroEnCadena = numero + "";
  return numeroEnCadena === 3;
}
