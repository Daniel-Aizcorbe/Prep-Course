...
function incrementarPorUno(array) {
  ...
  // y devuelve el array
  // Tu código:
  const arrayAumentado = array.map(num => num+1);
...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  let resultados = agregarNumeros(resultadosTest);
...
function mayorACien(array) {
  ...
  // Tu código:
  const mayoresA100 = array.filter(num => num > 100);
  return mayoresA100;
}
...
function breakStatement(numero) {
  ...
  for(let i = 0; i < 10; i++) {
    ...
    numeroAumentado.push(numeroInicial);
  }
